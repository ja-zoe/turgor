...
// Completes sign-in for every token-minting flow: /cas/callback (real CAS) and the
// R28.1 email magic-link callback both redirect here with ?token=<handoff token>.
