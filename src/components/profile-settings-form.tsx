      ...
      <div className="p-5 bg-card border border-border rounded-xl space-y-4">
        ...
        <div className="flex items-center gap-3 pt-1">
          <button
            ...
            className="rounded-md cursor-pointer bg-primary text-primary-foreground text-sm font-medium px-5 py-2.5 hover:bg-primary/80 disabled:opacity-50 transition-colors inline-flex items-center gap-1.5"
          >
            {isPending ? (<><ActionSpinner /> Saving…</>) : "Save changes"}
          </button>
          {saved && !isPending && (
